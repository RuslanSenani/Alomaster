...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("../lib/codemirror"), require("../addon/search/searchcursor.js"), require("../addon/dialog/dialog.js"), require("../addon/edit/matchbrackets.js"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["../lib/codemirror", "../addon/search/searchcursor.js", "../addon/dialog/dialog", "../addon/edit/matchbrackets"], mod);
  ...
  var Vim = function() {
    ...
    * in the right place.
    ...
    function parseQuery(query, ignoreCase, smartCase) {
      // First edit the last search register
    ...
    ExCommandDispatcher.prototype = {
      ...
      _processCommand: function(cm, input, opt_params) {
        ...
        // edit ": with the latest command whether valid or invalid
    ...
    */
    ...
    function exitInsertMode(cm) {
      ...
      // edit the ". register before exiting insert mode
