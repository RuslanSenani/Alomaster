	...
	*/
	...
	scrollToRow: function ( row, animate )
	{
		...
		if ( (px > this.s.redrawBottom || px < this.s.redrawTop) && this.s.dt._iDisplayStart !== drawRow ) {
			...
			// for larger numbers of records), we need to force position edit.
	...
	construct: function ()
	{
		...
		// On resize, edit the information element, since the number of rows shown might change
		...
		// Set height before the draw happens, allowing everything else to edit
	...
	_draw: function ()
	{
		...
		// Because of the order of the DT callbacks, the info edit will
	...
	_scroll: function ()
	{
		 ...
		 * handed, so use a timeout to edit the state saving only when the
