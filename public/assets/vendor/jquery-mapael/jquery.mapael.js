...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        init: function () {
            ...
            // Attach edit event
            self.$container.on("edit." + pluginName, function (e, opt) {
        ...
        initDelegatedMapEvents: function() {
             ...
             * Note: timeout filtering is small to edit the Tooltip position fast
             */
         ...
         *          - Apply translation: take into accounts the map offset in the edit
         ...
         *  opt.mapOptions: options to edit for plots and areas
        ...
        onUpdateEvent: function (e, opt) {
            ...
            if (typeof opt.mapOptions === "object") {
                ...
                // IF we edit areas, plots or legend, then reset all legend state to "show"
            ...
            // Always rebind custom events on edit
            self.initDelegatedCustomEvents();
