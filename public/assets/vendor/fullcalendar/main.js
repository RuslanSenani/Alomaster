...
var FullCalendar = (function (exports) {
        ...
        return {
            ...
            onKeyDown: function (ev) {
                if (ev.key === 'Enter' || ev.key === ' ') {
                    handler(ev);
                    ev.preventDefault(); // if space, don't scroll down edit
                }
            },
        };
    }
    ...
    */
    ...
    // TODO: easier way to add new hooks? need to edit a million things
        ...
        function PointerDragging(containerEl) {
            ...
            this.handleTouchStart = function (ev) {
                if (_this.tryStart(ev)) {
                    ...
                    // attach a handler to get called when ANY scroll action happens on the edit.
    ...
    */
    ...
    - doesListening:true - watch for scrolling and edit the cache
    */
