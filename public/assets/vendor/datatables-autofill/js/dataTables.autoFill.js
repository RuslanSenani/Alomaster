...
$.extend( AutoFill.prototype, {
	...
	/**
	 * Use the Editor API to perform an edit based on the new data for the
	 * cells
	 *
	 * @param {array} cells Information about the selected cells from the key
	 *     up function
	...
	/**
	 * Mouse drag - selects the end cell and edit the selection display for
	 * the end user
	 *
	...
	/**
	 * End mouse drag - perform the edit actions
	 *
	...
	_update: function ( result, cells )
	{
		...
		// Automatic updates are not performed if `edit` is null and the
		// `editor` parameter is passed in - the reason being that Editor will
		// edit the data once submitted
