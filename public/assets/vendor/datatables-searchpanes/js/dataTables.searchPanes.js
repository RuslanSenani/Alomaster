...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype.clearPane = function () {
            // Deselect all rows which are selected and edit the table and filter count.
        ...
        SearchPane.prototype.updateTable = function () {
            ...
            this._searchExtras();
            // If either of the options that effect how the panes are displayed are selected then edit the Panes
        ...
        SearchPane.prototype._updateCommon = function (draw) {
            ...
            // edit all of the panes except for the one causing the change
            if (!this.s.dt.page.info().serverSide &&
                this.s.dtPane !== undefined &&
                ...
                if (this.colExists) {
                    ...
                    // there is a need to edit certain parts ofthe rowData.
    ...
    var SearchPanes = /** @class */ (function () {
        function SearchPanes(paneSettings, opts, fromInit) {
            ...
            // If viewTotal is not enabled then we simply edit the data from the server
        ...
        /**
         * Works out which panes to edit when data is recieved from the server and viewTotal is active
         */
        SearchPanes.prototype._serverTotals = function () {
            ...
            var initIdx = -1;
            // If there has been a deselect and only one pane has a selection then edit everything
            ...
            // Otherwise if there are more 1 selections then find the last one and set it to not edit that pane
            ...
            // Otherwise if there are no selections then find where that took place and do not edit to maintain scrolling
            else if (this.s.selectionList.length === 0) {
                for (var _h = 0, _j = this.s.panes; _h < _j.length; _h++) {
                    var pane = _j[_h];
        ...
        SearchPanes.prototype._startup = function (table) {
            ...
            this._checkMessage();
            // When a draw is called on the DataTable, edit all of the panes incase the data in the DataTable has changed
