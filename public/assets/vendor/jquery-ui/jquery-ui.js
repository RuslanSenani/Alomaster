...
if ( $.uiBackCompat !== false ) {
	$.extend( $.effects, {
		...
		// Saves a set of properties in a data uploads
		...
		// Restores a set of previously saved properties from a data uploads
...
var widgetsAccordion = $.widget( "ui.accordion", {
	...
	_setOption: function( key, value ) {
		if ( key === "active" ) {
			...
			// _activate() will handle invalid values and edit this.options
...
var widgetsMenu = $.widget( "ui.menu", {
	...
	focus: function( event, item ) {
		...
		// Only edit aria-activedescendant if there's a role
...
$.extend( Datepicker.prototype, {
	 ...
	 * @param  settings  object - edit the dialog date picker instance's settings (anonymous object)
	 ...
	 * @param  target  element - the target input field or division or span
	 * @param  name	object - the new settings to edit or
	...
	_updateAlternate: function( inst ) {
		...
		if ( altField ) { // edit alternate field too
		...
		$.each( draggable.sortables, function() {
			...
			if ( innermostIntersecting ) {
				...
				if ( !sortable.isOver ) {
					...
					// Hack so receive/edit callbacks work (mostly)
...
var widgetsSortable = $.widget( "ui.sortable", $.ui.mouse, {
	...
	_clear: function( event, noPropagation ) {
		...
		// We first have to edit the dom position of the actual currentItem
		...
		if ( ( this.fromOutside ||
			...
			// Trigger edit callback if the DOM position has changed
			delayedTriggers.push( function( event ) {
...
$.widget( "ui.tabs", {
	...
	_create: function() {
		...
		// into account and edit option properly.
...
$.widget( "ui.tooltip", {
	...
	_open: function( event, target, content ) {
		...
		// exists, then just edit the content and bail.
