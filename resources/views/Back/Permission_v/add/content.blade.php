                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="form-group">
                                                <label for="permissionName">Səlahiyyət Adı:</label>
                                                <input type="text" value="{{old('permissionName')}}" name="permissionName" class="form-control" id="permissionName"
                                                       placeholder="Səlahiyyət Adı">
                                            </div>
                                        </div>
                                    </div>
                                </div>
