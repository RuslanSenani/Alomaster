                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($brands  as $brand)
                            <tr id="ord-{{$brand->id}}" data-url="{{route('ajax-brands-rankSetter')}}">

                                <th><i class="fa-solid fa-list-ol"></i></th>

                                <td class="col-md-1">#{{$brand->id}}</td>

                                <td class="col-md-2">{{$brand->title}}</td>

                                <td class="col-md-1">
                                    <div class="image">
                                        <img
                                            src="{{asset($brand->img_url)}}"
                                            alt="Brend Şəkli"
                                ...
                                <td class="col-md-1">
                                    <label class="toggle">
                                        <input type="checkbox" class="isActive"
                                               data-url="{{route('ajax.brands-is-active-setter',$brand->id)}}"
                                               name="isActive" {{ $brand->isActive ? 'checked' : '' }} />
