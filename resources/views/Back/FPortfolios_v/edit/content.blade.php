                            ...
                            <div class="card-body">
                                ...
                                <div class="from-group col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{$portfolio->title}}"
                                                       name="title"
                                            ...
                                            <select name="category_id" class="form-control select2bs4">
                                                ...
                                                @foreach($portfoliosCategories as $portfoliosCategory)
                                                    <option value="{{ $portfoliosCategory->id }}"
                                                            {{ (old('supplier', $portfolio->category_id ?? '') == $portfoliosCategory->id) ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group date" id="reservationdate"
                                                ...
                                                <input name="finishedAt" type="text"
                                                       value="{{\Carbon\Carbon::parse($portfolio->finishedAt)->format('m/d/Y')}}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$portfolio->client}}"
                                                               name="client"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$portfolio->place}}"
                                                               name="place"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$portfolio->portfolio_url}}"
                                                                   name="portfolio_url"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" placeholder="Açıqlama">               {{$portfolio->description}}
                                                </textarea>
