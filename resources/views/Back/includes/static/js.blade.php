...
<script src="{{asset("assets")}}/vendor/sparklines/sparkline.js"></script>

<script src="{{asset("assets")}}/vendor/jqvmap/jquery.vmap.min.js"></script>

<script src="{{asset("assets")}}/vendor/jqvmap/maps/jquery.vmap.usa.js"></script>
...
<script src="{{asset("assets")}}/vendor/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
