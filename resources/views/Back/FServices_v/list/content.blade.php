                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($services  as $service)
                            ...
                            <tr id="ord-{{$service->id}}" data-url="{{route('ajax.files-rankSetter-services')}}">
                                ...
                                <td class="col-md-2">{{$service->url}}</td>
                                ...
                                <td class="col-md-1">
                                    <label class="toggle">
                                        <input type="checkbox" class="isActive"
                                               data-url="{{route('ajax.is-active-setter-services',$service->id)}}"
                                               name="isActive" {{ $service->isActive ? 'checked' : '' }} />
