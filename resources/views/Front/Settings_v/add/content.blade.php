                ...
                <form action="{{route('settings.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="custom-content-below-tabContent">
                            ...
                            @include('Front.Settings_v.add.tabs.site_info')

                            @include('Front.Settings_v.add.tabs.address')

                            @include('Front.Settings_v.add.tabs.about_us')

                            @include('Front.Settings_v.add.tabs.mission')

                            @include('Front.Settings_v.add.tabs.vision')

                            @include('Front.Settings_v.add.tabs.social')

                            @include('Front.Settings_v.add.tabs.logo')
