<div class="tab-pane fade" id="custom-content-below-social" role="tabpanel"
     aria-labelledby="custom-content-below-social-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('tik_tok')}}" name="tik_tok"
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('youtube')}}" name="youtube"
